...
def _prompt_sistema(banda_clave, banda_etiqueta, perspectiva="familia"):
    ...
    return (
        ...
        "- CRITICO: tu respuesta es UNICAMENTE el texto que va al documento. "
        "NUNCA hagas preguntas, comentarios, advertencias ni aclaraciones — "
        "aunque los datos te parezcan inconsistentes o incompletos, redacta "
        "directamente con lo que tienes, sin cuestionarlo, sin dirigirte a "
        "nadie. El texto pasa directo al cuaderno ICBF sin ningun intermediario.\n"
    )
...
def redactar(banda_clave, banda_etiqueta, instruccion, materia_prima,
    ...
    client = _get_client()
    texto_usuario = (
        "Redacta lo siguiente para el cuaderno ICBF: " + instruccion + "\n\n"
        "Informacion de base:\n"
        "'''\n" + materia_prima.strip() + "\n'''\n\n"
        ...
        "Responde UNICAMENTE con el texto del documento, sin comentarios previos "
        "ni posteriores. "
    ...
    trabajos = [
        ("intencionalidad", dict(
            ...
            instruccion=(
                ...
                "VERBO PEDAGOGICO + lista de 2 o 3 competencias/habilidades ESPECIFICAS "
                "que esta experiencia desarrolla + conector ('a traves de', 'mediante', "
                "'por medio de') + descripcion tecnica de la metodologia pedagogica. "
                "Elige el verbo que mejor corresponda a lo que se busca desarrollar en "
                "esta experiencia especifica. Verbos posibles (elige UNO, el mas adecuado): "
                "Fortalecer, Estimular, Potenciar, Desarrollar, Promover, Ampliar, "
                "Favorecer, Consolidar, Ejercitar, Explorar, Enriquecer, Afianzar, "
                "Fomentar, Propiciar, Cultivar. "
                "Ejemplo de estructura y nivel esperado: 'Fomentar la escucha activa, el "
